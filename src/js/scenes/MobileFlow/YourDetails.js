...
import {
  ...
  Label, Input, Button, FormFeedback,
  UncontrolledAlert, Card, CardBody
} from 'reactstrap';
...
class MobileYourDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <Section className="main-section bg-maze">
        <Container>
          <h3 className="title-underlined-primary title-underlined-center text-center font-weight-extrabold">
            Add a mobile service
          </h3>
          <div className="eat-container">
            <Step steps={['Choose plan', 'Your Details', 'Identity', 'Confirm']} index={1} />
                ...
                <Formik
                  ...
                  render={({
                    ...
                    <Form onSubmit={handleSubmit}>
                      ...
                      <h4 className="title-underlined-primary font-weight-extrabold">
                        Your details
                      </h4>
                      <Row>
                        <Col md={3}>
                        ...
                        <Col md={4}>
                          <FormGroup>
                            ...
                            <small className="form-text text-muted mt-0">
                              This must be a physical address, we cannot accept Post Office Box addresses.
                      ...
                      <FormGroup>
                        <div className="d-flex justify-content-between">
                          <Button
                            ...
                            color="primary"
                            outline
                            className="font-weight-extrabold btn-round text-uppercase mr-4"
...
export default MobileYourDetails;
