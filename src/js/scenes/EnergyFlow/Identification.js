...
class EnergyIdentification extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    this.medicareRef = React.createRef();
  ...
  handleSubmit(values, bags) {
    const {
      pack_type, your_details, identification_type, special_requirements, compare_bill
    } = this.state;
    this.props.history.push('/dashboard/energy/confirm', {
      pack_type,
      compare_bill,
      your_details,
      ...
      <Section className="main-section bg-maze">
        <Container>
          ...
          <div className="eat-container">
            <Step steps={['Choose plan', 'Special requirements', 'Your Details', 'Identification', 'Confirm']} index={3} />
...
export default EnergyIdentification;
