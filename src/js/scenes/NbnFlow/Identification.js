...
class NbnIdentification extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleSubmit(values, bags) {
    const {
      pack_type, your_details, identification_type, special_requirements
    } = this.state;
    this.props.history.push('/dashboard/nbn/confirm', {
      pack_type,
      your_details,
...
export default NbnIdentification;
