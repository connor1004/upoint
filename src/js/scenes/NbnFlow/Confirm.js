...
class NbnConfirm extends Component {
  ...
  handleSubmit() {
    const {
      pack_type, identification_type, identity, your_details, special_requirements
    } = this.state;
  ...
  handleGotoStepIdentity() {
    ...
    this.props.history.push('/dashboard/mobile/identification', {
      pack_type,
      special_requirements,
      your_details
    });
  ...
  render() {
    const {
      your_details, agree_terms1, agree_terms2, identification_type, identity
    } = this.state;
    return (
            ...
            <Row>
              <Col md={6}>
                <Card className="form-card">
                  <CardBody className="card-body-p-lg">
                    <Row>
                      <Col className="text-right">
                        <h5 className="card-title title-underlined-primary float-left font-weight-bold">Address</h5>
                        <Button
                          type="button"
                          size="sm"
                  ...
                  <CardBody className="card-stack card-body-p-lg">
                    <Row>
                      <Col className="text-right">
                  ...
                  <CardBody className="card-body-p-lg card-stack d-none d-md-block">
                    <div className="mb-6">
                      <span className="switch">
                        <input
                          type="checkbox"
                          id="switch_agree_terms1"
                          checked={agree_terms1}
                          onChange={(event) => {
                            this.setState({
                              agree_terms1: event.target.checked
                            });
                          }}
                        />
                        <Label htmlFor="switch_agree_terms1">
                          <span className="text-muted">
                            I have read and understood the limitations of the speeds available to me as described in the&nbsp;
                            <NavLink className="text-primary" to="#">NBN Speed Guidelines</NavLink>
                          </span>
                        </Label>
                      </span>
                    </div>
                    <div className="mb-4">
                      <span className="switch">
                        <input
                          type="checkbox"
                          id="switch_agree_terms2"
                          checked={agree_terms2}
                          onChange={(event) => {
                            this.setState({
                              agree_terms2: event.target.checked
                            });
                          }}
                        />
                    ...
                    <div className="mb-4">
                      <Button
                        ...
                        disabled={!agree_terms1 || !agree_terms2}
              ...
              <Col md={6}>
                <Card className="form-card">
                  <CardBody className="card-body-p-lg">
                    <h3 className="card-title title-underlined-primary title-underlined-center text-center font-weight-extrabold">Order summary</h3>
                    <Row>
                      <Col xs={6}>
                        <div className="text-primary mb-4">
                  ...
                  <CardBody className="card-body-p-lg bg-primary">
                    <Row className="text-white">
                      <Col xs={6}><strong>Total up front</strong></Col>
                      <Col xs={6}>
                        <strong>
                          $0.00
                        </strong>
                    ...
                    <Row className="text-white">
                      <Col xs={6}><strong>Total on-going</strong></Col>
                      <Col xs={6}>
                        <strong>
                          $65 per month
                        </strong>
                ...
                <p className="font-size-md">* $0 activation fee offered for customers who remain on an active NBN plan for 12 months. Fees may apply for early termination.</p>
              </Col>
            </Row>
          </div>
        </Container>
