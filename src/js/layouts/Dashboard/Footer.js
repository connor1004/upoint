      ...
      <Row>
        <Col lg="7" md="8">
          <ul className="footer-menu">
            <li>
              <Link to="/order-sim">Order a SIM</Link>
            </li>
            <li>
              <Link to="/order-sim">Plans</Link>
            </li>
            <li>
              <Link to="/order-sim">uPoint Cards</Link>
            </li>
            <li>
              <Link to="/order-sim">Contact</Link>
            </li>
            <li>
              <Link to="/order-sim">About us</Link>
            </li>
            <li>
              <Link to="/order-sim">Partners</Link>
            </li>
            <li>
              <Link to="/order-sim">Help</Link>
            </li>
            <li>
              <Link to="/order-sim">Portal</Link>
            </li>
            <li>
              <Link to="/order-sim">Our Customer Terms</Link>
            </li>
            <li>
              <Link to="/order-sim">Terms of use</Link>
            </li>
            <li>
              <Link to="/order-sim">Privacy</Link>
            </li>
          </ul>
        </Col>
